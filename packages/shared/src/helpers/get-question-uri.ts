import { IQanaryMessage } from "../interfaces/qanary-interfaces";

import { QuestionSparqlResponse } from "../interfaces/question-sparql-response";
import { getEndpoint, getInGraph } from "../helpers/message-operations";
import { selectSparql } from "../helpers/query-sparql";
import { getQuestionUriQuery } from "../helpers/question-uri-query";
